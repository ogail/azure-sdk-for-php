...
class Resources
{
    ...
    const XTAG_CERTIFICATE = 'Certificate';
    const XTAG_CERTIFICATE_URL = 'CertificateUrl';
    const XTAG_THUMBPRINT = 'Thumbprint';
    const XTAG_THUMBPRINT_ALGORITHM = 'ThumbprintAlgorithm';
    const XTAG_DATA = 'Data';
